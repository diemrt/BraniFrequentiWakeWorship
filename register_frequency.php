        ...
        <form class="mt-6 space-y-4 bg-white py-6 px-6 shadow-lg rounded-lg" method="post">
            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <input type="date" name="data" id="data" value="<?php echo date('Y-m-d'); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500" required>
                </div>
            </div>
            <?php if ($message): ?>
