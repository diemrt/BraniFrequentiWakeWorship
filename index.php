...
<?php if (empty($brani)): ?>
    <div class="text-center py-12">
        <svg class="w-16 h-16 text-gray-400 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.182 16.318A4.486 4.486 0 0 0 12.016 15a4.486 4.486 0 0 0-3.198 1.318M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Z" />
        </svg>

        <p class="text-gray-500 text-lg">Non abbiamo trovato nessun brano da mostrare. Controlla i filtri o programma una nuova scaletta.</p>
    </div>
<?php else: ?>
    <?php foreach ($grouped as $date => $brani_per_data): ?>
        <div class="mb-6 md:mb-8 bg-white shadow-lg rounded-lg p-4">
            <!-- Date Header -->
